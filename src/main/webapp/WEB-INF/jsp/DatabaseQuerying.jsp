<%@include file="Header.jsp" %>
	...
	<div class="row">
			...
			<div id="sidemabr1">
				<div class="btn-group dropright span9 btn-block no-padding">
					<button type="button"
						...
						data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Species</button>
					<div class="dropdown-menu">
						<a class="dropdown-item" href="#">View plants list</a> <a
							class="dropdown-item" href="#">View treatments given</a>
					</div>
				</div>
				<div class="btn-group dropright span9 btn-block no-padding">
					<button type="button"
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="#">View phenotypic data</a> <a
							...
							<a
							class="dropdown-item" href="#">View image sequence</a>
					</div>
				</div>
				<div class="btn-group dropright span9 btn-block no-padding">
					<button type="button"
				...
				<div class="btn-group dropright span9 btn-block no-padding">
					<button type="button"
						class="btn btn-secondary btn-block dropdown-toggle"
						data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Adhoc</button>
					<div class="dropdown-menu">
						<a class="dropdown-item" href="#">View phenotypes list</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container col-8">
			<p>Here you can perform dababase querying based on plants and
